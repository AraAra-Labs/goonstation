...
/datum/fungi_gene_strain
	...
	proc/on_process(var/obj/machinery/fungusbox/PP)
		if (!PP)
			return 1
		if (!PP.current)
			return 1
...
/datum/fungi_gene_strain/nutrient_toxin
	name = "Toxin Nutrition"
	desc = "This genetic strain enables a fungus to absorb nutrients from toxic substances."

/datum/fungi_gene_strain/metabolism_heat
	name = "Thermosynthesis"
	desc = "This gene allows a fungus to use heat to power its metabolism."
	/datum/fungi_gene_strain/metabolism_light
	name = "Photosynthesis"
	desc = "This gene allows a fungus to use light to power its metabolism."
/datum/fungi_gene_strain/metabolism_radiation
	name = "Radiosynthesis"
	desc = "This gene allows a fungus to use radiation to power its metabolism."

/datum/fungi_gene_strain/metabolism_fast
	name = "Fast Metabolism"
	desc = "This gene causes a fungus to grow faster, but also consume nutrients more rapidly."

/datum/fungi_gene_strain/metabolism_slow
	name = "Slow Metabolism"
	desc = "This gene slows the growth of a fungus, but reduces nutrient consumption."

/datum/fungi_gene_strain/growth_fast
	name = "Aggressive Colonization"
	desc = "This gene accelerates a fungus's colonization, but makes it less resistant to competition"

	on_process(var/obj/machinery/fungusbox/PP)
		if (..())
			return
		PP.growth += 2

/datum/fungi_gene_strain/growth_slow
	name = "Slow Colonization"
	desc = "This gene slows a fungus's colonization, but makes it more resistant to competition"
	negative = 1
...
/datum/fungi_gene_strain/unstable
	name = "Unstable"
...
/datum/fungi_gene_strain/photosynthesis
...
/datum/fungi_gene_strain/reagent_adder
	name = "Hyperaquacity"
...
/datum/fungi_gene_strain/reagent_adder/toxic
	name = "Toxic"
